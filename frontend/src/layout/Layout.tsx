    ...
    <div className="flex min-h-screen w-full flex-col bg-muted/40">
      <aside className="fixed inset-y-0 left-0 z-10 hidden w-14 flex-col border-r bg-background sm:flex">
        <nav className="flex flex-col items-center gap-4 px-2 sm:py-5">
          ...
          >
            <Eclipse className="h-4 w-4 transition-all group-hover:scale-110" />
          </Link>
      ...
      <div className="flex flex-col sm:gap-4 sm:py-4 sm:pl-14 h-screen overflow-y-scroll">
        ...
        <main className="w-full h-full max-h-full p-4 sm:px-6 sm:py-0 md:gap-8">
          <Outlet />
        </main>
      </div>
    </div>
